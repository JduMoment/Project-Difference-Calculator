...
def test_generate_stylish_lines():
    ...
    result_nested = generate_diff('gendiff/tests/fixtures/file4_for_test.yml'
...
def test_generate_stylish_lines():
    result = generate_diff('gendiff/tests/fixtures/file1_for_test.yml'
                           'gendiff/tests/fixtures/file2_for_test.json',
                           'plain')
    verif_flat = read_file('gendiff/tests/fixtures/expect_flat_stylish.txt')
    assert result == verif_flat
